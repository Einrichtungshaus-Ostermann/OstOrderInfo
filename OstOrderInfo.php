 ...
 *
 * Customers (online and stationary) can login in using their order and
 * customer number to get information of their order and its current status.
 *
 * 1.0.0
 * - initial release
 *
...
namespace OstOrderInfo;

use Shopware\Components\Plugin;
use Shopware\Components\Plugin\Context;
use Symfony\Component\DependencyInjection\ContainerBuilder;

class OstOrderInfo extends Plugin
{
    /**
     * ...
     *
    ...
    public function build(ContainerBuilder $container)
    {
        ...
        $container->setParameter('ost_order_info.plugin_dir', $this->getPath() . '/');
        $container->setParameter('ost_order_info.view_dir', $this->getPath() . '/Resources/views/');
